...
xnoremap  ca :call OmniSharp#GetCodeActions('visual')
nnoremap  ca :OmniSharpGetCodeActions
noremap  cp :CtrlP
map  rs :source my.vim
omap  ss :mksession! my.vim
map  lb :MBEbp
map  nb :MBEbn
map  bl :MBEToggle
nmap  fl :NERDTreeToggle
nnoremap  jd :YcmCompleter GoToDefinition
noremap  jc :YcmCompleter GoToDeclaration
nmap  tp :tprevious
nmap  tn :tnext
...
set previewheight=5
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vim-monokai,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-cpp-enhanced-highlight,~/.vim/bundle/tagbar,~/.vim/bundle/DfrankUtil,~/.vim/bundle/vimprj,~/.vim/bundle/nerdcommenter,~/.vim/bundle/ultisnips,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/nerdtree,~/.vim/bundle/minibufexpl.vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/omnisharp-vim,~/.vim,~/.vim/bundle/vim-monokai,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-cpp-enhanced-highlight,~/.vim/bundle/tagbar,~/.vim/bundle/DfrankUtil,~/.vim/bundle/vimprj,~/.vim/bundle/nerdcommenter,~/.vim/bundle/ultisnips,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/nerdtree,~/.vim/bundle/minibufexpl.vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/omnisharp-vim,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-monokai/after,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle
set shiftwidth=4
...
silent! normal! zE
let s:l = 272 - ((48 * winheight(0) + 25) / 50)
